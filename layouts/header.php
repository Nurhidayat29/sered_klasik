...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <meta property="og:type" content="article"/>
	  ...
	  <?php else: ?>
		...
		<?php endif; ?>
	  <link type='text/css' href="<?= base_url()?>desa/themes/sered_klasik/assets/front/css/first.css" rel='Stylesheet' />
	  ...
	  <link type='text/css' href="<?= base_url().$this->theme_folder.'/'.$this->theme.'/css/first.css'?>" rel='Stylesheet' />
		...
		<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v5.0&appId=478614799555442&autoLogAppEvents=1"></script>	
	</head>
								...
								<div id="divlogo">
									<div id="divlogo-txt">
										...
										<h2>
											...
											<?php echo ucwords($this->setting->sebutan_kabupaten." ".$desa['nama_kabupaten'])?><br/>
											<?php echo ucwords($this->setting->sebutan_propinsi."Propinsi ".$desa['nama_propinsi'])?></h2>
